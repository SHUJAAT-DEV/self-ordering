...
import useMenue from "../hooks/useTable";
import useTable from "../hooks/useTable";

type CreateTableProperties = {
  isOpen: boolean;
  onClose: () => void;
  data: any;
};

function CreateTable({ isOpen, onClose, data }: CreateTableProperties) {
      ...
      >
        <Row gutter={24}>
          <Col span={12}>
            ...
            >
              <Input placeholder="Please insert table number!" />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item
